...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { color: @shoe.color, string: @shoe.string, type: @shoe.type } }, as: :json
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { color: @shoe.color, string: @shoe.string, type: @shoe.type } }, as: :json
    assert_response 200
  end
